...
- Average points over X on member page
...
- Show correct value for points at 3rd month deadline
...
- Start to member page

### Improved

- Improved members page
- Standardized some small things around the site
...
- Rank column on the members page
